...
/** Исходный план: недели и занятия как задумано. Правки владельца (порядок, свои недели и занятия,
    удаления) в эти данные не пишутся — они накладываются при чтении в planEdits.ts (applyEdits) */

    ...
    <main className="notebook">
      <header className="page-head">
        ...
        <p className="page-head__lead">
          Свои конспекты, разборы задач и шпаргалки. Разметка та же, что в конспектах: заголовки, списки, таблицы, формулы в <code>$…$</code> и{' '}
      ...
      <div className="notebook__layout">
        ...
        {mode.kind === 'edit' ? (
          ...
          <section className="notebook__view notebook__view--empty" aria-label="Заметок нет">
            <p className="notebook__empty">Заметок пока нет. Нажмите «Новая заметка» — разметка как в конспектах, формулы через $…$.</p>
          </section>
        )}
      </div>
    </main>
    ...
    >
      <div className="notebook__field">
        ...
        <input
          ...
          type="text"
          value={title}
          placeholder="Например: производная сложной функции — разбор"
      ...
      <div className="notebook__pane">
        <div className="notebook__field">
          ...
          <textarea
            ...
            value={body}
            spellCheck={false}
            placeholder={'## Заголовок\n\nТекст с формулой $x^2$ и выключной формулой:\n\n$$\n\\lim_{x\\to 0} \\frac{\\sin x}{x} = 1\n$$'}
          ...
          />
          <p className="notebook__hint">Ctrl+S — сохранить. Формулы в строке — $…$, на своей строке — $$…$$.</p>
        </div>
